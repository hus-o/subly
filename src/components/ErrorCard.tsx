...
function ErrorCard({status, name, cover, errorMessage}: ErrorProps): JSX.Element {
    return(
        ...
        <div className="group h-3/4 relative">
            ...
            <div className="flex flex-col items-center justify-around h-3/4 w-full absolute top-1/2 left-1/2 transform -translate-y-2/4 -translate-x-2/4 font-semibold">
